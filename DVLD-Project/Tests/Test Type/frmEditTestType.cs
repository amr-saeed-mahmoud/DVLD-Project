...
namespace DVLD_Project
{
    ...
    {
        private TestType.enTestType TestID;
        private TestType testType;

        public frmEditTestType(TestType.enTestType TestID)
        {
            InitializeComponent();
            this.TestID = TestID;
        }
        ...
        private void frmEditTestType_Load(object sender, EventArgs e)
        {
            ...
            if(testType == null)
            {
                MessageBox.Show("Test Type Doesn't Exist", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            testType.Fees = Convert.ToSingle(txtFees.Text.Trim());
        ...
        private void txtFees_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!Validation.IsValidNumber(txtFees.Text))
            {
                e.Cancel = true;
