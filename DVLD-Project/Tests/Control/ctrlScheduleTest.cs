...
namespace DVLD_Project
{
    public partial class ctrlScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            {
                lblRetakeAppFees.Text = ApplactionType.Find((int) DVLD_Business.Application.enApplicationType.RetakeTest).Fees.ToString();
            ...
            {
                lblFees.Text = TestType.Find(_TestTypeID).Fees.ToString();
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                DVLD_Business.Application Application = new DVLD_Business.Application();

                Application.ApplicantPersonID = _LocalDrivingLicenseApplication.ApplicantPersonID;
                Application.ApplicationDate = DateTime.Now;
                Application.ApplicationTypeID = (int)DVLD_Business.Application.enApplicationType.RetakeTest;
                Application.ApplicationStatus = DVLD_Business.Application.enApplicationStatus.Completed;
                Application.LastStatusDate = DateTime.Now;
                Application.PaidFees = DVLD_Business.ApplactionType.Find((int)DVLD_Business.Application.enApplicationType.RetakeTest).Fees;
                Application.CreatedByUserID = Global.CurUser.UserID;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.CreatedByUserID = Global.CurUser.UserID;
