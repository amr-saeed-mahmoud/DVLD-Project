...
namespace DVLD_Project.Application.Release_Detained_License
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            lblApplicationFees.Text = DVLD_Business.ApplactionType.Find((int)DVLD_Business.Application.enApplicationType.ReleaseDetainedDrivingLicsense).Fees.ToString();
        ...
        private void btnRelease_Click(object sender, EventArgs e)
        {
            ...
            bool IsReleased = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.ReleaseDetainedLicense(Global.CurUser.UserID, ref ApplicationID); ;
