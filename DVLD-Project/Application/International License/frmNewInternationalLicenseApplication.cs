using DVLD_Project.License.International_License;
...
namespace DVLD_Project.Application.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void frmNewInternationalLicenseApplication_Load(object sender, EventArgs e)
        {
            ...
            lblFees.Text = DVLD_Business.ApplactionType.Find((int)DVLD_Business.Application.enApplicationType.NewInternationalLicense).Fees.ToString();
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            InternationalLicense.ApplicationStatus = DVLD_Business.Application.enApplicationStatus.Completed;
            InternationalLicense.LastStatusDate = DateTime.Now;
            InternationalLicense.PaidFees = DVLD_Business.ApplactionType.Find((int)DVLD_Business.Application.enApplicationType.NewInternationalLicense).Fees;
            InternationalLicense.CreatedByUserID = Global.CurUser.UserID;
