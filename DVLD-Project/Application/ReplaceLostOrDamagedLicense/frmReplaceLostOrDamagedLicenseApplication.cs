    ...
    public partial class frmReplaceLostOrDamagedLicenseApplication : Form
    {
        ...
        private int _GetApplicationTypeID()
        {
            ...
            if (rbDamagedLicense.Checked)
                ...
                return (int)DVLD_Business.Application.enApplicationType.ReplaceDamagedDrivingLicense;
            else
                return (int)DVLD_Business.Application.enApplicationType.ReplaceLostDrivingLicense;
        }
        ...
        private void rbDamagedLicense_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblApplicationFees.Text = DVLD_Business.ApplactionType.Find(_GetApplicationTypeID()).Fees.ToString();
        }
