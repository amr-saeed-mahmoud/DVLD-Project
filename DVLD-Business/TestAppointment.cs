...
namespace DVLD_Business
{
    public class TestAppointment
    {
        ...
        public DVLD_Business.Application RetakeTestAppInfo { set; get; }
...

        {
            ...
            this.RetakeTestAppInfo = DVLD_Business.Application.FindBaseApplication(RetakeTestApplicationID);
            Mode = enMode.Update;
        }
